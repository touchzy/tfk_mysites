...
def wechat_dailyreport(wechat_articles_salt, wechat_articles_fat, date, counts_dict):
    ...
    for wechat in wechat_articles_salt:
        ...
        article_content = article_content.replace("#article_url#", wechat.url)
        article_content = article_content.replace("#title_cn#", wechat.title)
        article_content = article_content.replace("#read_num#", str(wechat.read_num))
        article_content = article_content.replace("#source#", wechat.user)
        article_content = article_content.replace("#source_en#", wechat.source_en)
